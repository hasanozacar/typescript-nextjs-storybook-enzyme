...
export default {
  ...
  argTypes: {
    rightBackFender: {
      control: { type: "object" },
      defaultValue: { color: color.orginal, title: "orginal" },
    },
    backBonnet: {
      control: { type: "object" },
      defaultValue: { color: color.painted, title: "painted" },
    },
    leftBackFender: {
      control: { type: "object" },
      defaultValue: { color: color.localPainted, title: "Local Painted" },
    },
    rightBackDoor: {
      control: { type: "object" },
      defaultValue: { color: color.changed, title: "Changed" },
    },
    rightFrontDoor: {
      control: { type: "object" },
      defaultValue: { color: color.orginal, title: "Orginal" },
    ...
    ceiling: {
      control: { type: "object" },
      defaultValue: { color: color.undoAndAttach, title: "Undo and Attach" },
    },
    leftBackDoor: {
      control: { type: "object" },
      defaultValue: { color: color.meekAndScratch, title: "Meek and Scratch" },
    },
    leftFrontDoor: {
      control: { type: "object" },
      defaultValue: { color: color.painted, title: "painted" },
