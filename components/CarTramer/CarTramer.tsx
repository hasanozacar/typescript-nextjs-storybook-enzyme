...
const CarTramer = ({ tramer }: CardProps) => {
  ...
  const [tramerColor, setTramerColor] = useState({
    rightBackFender: { color: "", title: "" },
    backBonnet: { color: "", title: "" },
    leftBackFender: { color: "", title: "" },
    rightBackDoor: { color: "", title: "" },
    rightFrontDoor: { color: "", title: "" },
    ceiling: { color: "", title: "" },
    leftBackDoor: { color: "", title: "" },
    leftFrontDoor: { color: "", title: "" },
    rightFrondFender: { color: "", title: "" },
    engineBonnet: { color: "", title: "" },
    leftFrondFender: { color: "", title: "" },
    frontBuffer: { color: "", title: "" },
    backBuffer: { color: "", title: "" },
  });
  const [dataTramer, setDataTramer] = useState(dataObject);
              ...
              <g>
                <g transform="translate(156.5 219.5) rotate(-90) translate(-188.5 -144.5)">
                  <g transform="translate(0)">
                    ...
                    <LeftBackDoor title={tramerColor.leftBackDoor.title} style={getStyleObjectFromString(
                      tramerColor.leftBackDoor.color
                    )} />

                    <LeftFrontDoor title={tramerColor.leftFrontDoor.title} style={getStyleObjectFromString(
                    ...
                    <path
                      ...
                      stroke="#D3D2D2"
                    ></path>
                    <FrontBuffer title={tramerColor.frontBuffer.title} style={getStyleObjectFromString(
                    ...
                    <path
                      ...
                      stroke="#D3D2D2"
                    ></path>
                    <LeftBackFender title={tramerColor.leftBackFender.title} style={getStyleObjectFromString(
                      tramerColor.leftBackFender.color
                    )} />
         
                    <LeftFrondFender title={tramerColor.leftFrondFender.title} style={getStyleObjectFromString(
                    ...
                    <path
                      ...
                      stroke="#D3D2D2"
                    ></path>
                    <RightFrondFender title={tramerColor.rightFrondFender.title} style={getStyleObjectFromString(
                      tramerColor.rightFrondFender.color
                    )} />

                    <RightFrontDoor title={tramerColor.rightFrontDoor.title} style={getStyleObjectFromString(
                      tramerColor.rightFrontDoor.color
                    )} />

                    <RightBackDoor title={tramerColor.rightBackDoor.title} style={getStyleObjectFromString(
                      tramerColor.rightBackDoor.color
                    )} />
                  
                    <RightBackFender title={tramerColor.rightBackFender.title} style={getStyleObjectFromString(
                      tramerColor.rightBackFender.color
                    )} />
                    <EngineBonnet title={tramerColor.engineBonnet.title} style={getStyleObjectFromString(
                      tramerColor.engineBonnet.color
                    )} />
                    <BackBonnet title={tramerColor.backBonnet.title} style={getStyleObjectFromString(
                    ...
                    <Ceiling title={tramerColor.ceiling.title} style={getStyleObjectFromString(
                    ...
                    <path
                      ...
                      stroke="#D3D2D2"
                    ></path>
                    <BackBuffer title={tramerColor.backBuffer.title} style={getStyleObjectFromString(
