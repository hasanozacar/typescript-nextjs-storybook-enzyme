              ...
              <g>
                <g transform="translate(156.5 219.5) rotate(-90) translate(-188.5 -144.5)">
                  <g transform="translate(0)">
                    ...
                    <LeftBackDoor
                      onClick={leftBackDoorClick}
                      title={tramerColor.leftBackDoor.title}
                      style={getStyleObjectFromString(
                    ...
                    <LeftFrontDoor
                      onClick={leftFrontDoorClick}
                      title={tramerColor.leftFrontDoor.title}
                      style={getStyleObjectFromString(
                    ...
                    ></path>
                    <FrontBuffer
                      onClick={frontBufferClick}
                      title={tramerColor.frontBuffer.title}
                      style={getStyleObjectFromString(
                    ...
                    ></path>
                    <LeftBackFender
                      onClick={leftBackFenderClick}
                      title={tramerColor.leftBackFender.title}
                      style={getStyleObjectFromString(
                    ...
                    <LeftFrondFender
                      onClick={leftFrondFenderClick}
                      title={tramerColor.leftFrondFender.title}
                      style={getStyleObjectFromString(
                    ...
                    ></path>
                    <RightFrondFender
                      onClick={rightFrondFenderClick}
                      title={tramerColor.rightFrondFender.title}
                      style={getStyleObjectFromString(
                    ...
                    <RightFrontDoor
                      onClick={rightFrontDoorClick}
                      title={tramerColor.rightFrontDoor.title}
                      style={getStyleObjectFromString(
                    ...
                    <RightBackDoor
                      onClick={rightBackDoorClick}
                      title={tramerColor.rightBackDoor.title}
                      style={getStyleObjectFromString(
                    ...
                    <RightBackFender
                      onClick={rightBackFenderClick}
                      title={tramerColor.rightBackFender.title}
                      style={getStyleObjectFromString(
                        tramerColor.rightBackFender?.color
                      )}
                    />
                    <EngineBonnet
                      onClick={engineBonnetClick}
                      title={tramerColor.engineBonnet.title}
                      style={getStyleObjectFromString(
                        tramerColor.engineBonnet?.color
                      )}
                    />
                    <BackBonnet
                      onClick={backBonnetClick}
                      title={tramerColor.backBonnet.title}
                      style={getStyleObjectFromString(
                        tramerColor.backBonnet?.color
                      )}
                    />
                    <Ceiling
                      onClick={ceilingClick}
                      title={tramerColor.ceiling.title}
                      style={getStyleObjectFromString(
                    ...
                    ></path>
                    <BackBuffer
                      onClick={backBufferClick}
                      title={tramerColor.backBuffer?.title}
                      style={getStyleObjectFromString(
