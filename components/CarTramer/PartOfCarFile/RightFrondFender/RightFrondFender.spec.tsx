...
import RightFrondFender from './index';
import { Tooltip } from '@material-ui/core';

const handleCustomButton = jest.fn();

describe('CarTramer', () => {
  const wrapper = mount(<RightFrondFender onClick={handleCustomButton}  title="testTooltip" style={{
    "stopColor": "#ffdb4d",
    "stopOpacity": "1",
  }} />);

  it('should render without throwing an error', () => {
    expect(wrapper.find(RightFrondFender).length).toEqual(1);
  });
