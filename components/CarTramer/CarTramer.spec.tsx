...
describe("CarTramer", () => {
  ...
  it("should render with LeftBackFender Props", () => {
    expect(wrapper.find(CarTramer).props().leftBackFender.title).toEqual(
      "orginal"
    );
  ...
  it("should render with RightBackFender Props", () => {
    expect(wrapper.find(CarTramer).props().rightBackFender.color).toEqual(
      color.orginal
    );
  ...
  it("should render with BackBuffer Props", () => {
    expect(wrapper.find(CarTramer).props().backBuffer.title).toEqual(
      "localPainted"
    );
  ...
  it("should render with RightBackDoor Props", () => {
    expect(wrapper.find(CarTramer).props().rightBackDoor.title).toEqual(
      "painted"
    );
  ...
  it("should render with RightFrontDoor Props", () => {
    expect(wrapper.find(CarTramer).props().rightFrontDoor).toEqual({
      color: color.painted,
      title: "painted",
    });
  ...
  it("should render with ceiling Props", () => {
    expect(wrapper.find(CarTramer).props().ceiling).toEqual({
      color: color.painted,
      title: "painted",
    });
  ...
  it("should render with LeftBackDoor Props", () => {
    expect(wrapper.find(CarTramer).props().leftBackDoor.title).toEqual(
      "painted"
    );
  ...
  it("should render with RightFrondFender Props", () => {
    expect(wrapper.find(CarTramer).props().rightFrondFender.title).toEqual(
      "painted"
    );
  ...
  it("should render with EngineBonnet Props", () => {
    expect(wrapper.find(CarTramer).props().engineBonnet.title).toEqual(
      "painted"
    );
  ...
  it("should render with leftFrondFender Props", () => {
    expect(wrapper.find(CarTramer).props().leftFrondFender.title).toEqual(
      "changed"
    );
  ...
  it("should render with frontBuffer Props", () => {
    expect(wrapper.find(CarTramer).props().frontBuffer.title).toEqual(
      "undoAndAttach"
    );
  ...
  it("should render with leftFrontDoor Props", () => {
    expect(wrapper.find(CarTramer).props().leftFrontDoor.title).toEqual(
      "painted"
    );
